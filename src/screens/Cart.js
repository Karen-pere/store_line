...
import { Text, View, TextInput, Image, TouchableOpacity, StyleSheet, Dimensions, ScrollView, Alert } from 'react-native';
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: "white" }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <ScrollView>
                                        ...
                                        <View style={{ flex: 1, backgroundColor: 'trangraysparent', padding: 10, justifyContent: "space-between" }}>
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                    ...
                                                    <Text style={{ paddingHorizontal: 8, fontWeight: 'bold', fontSize: 18, color: "black" }}>{item.quantity}</Text>
                        ...
                        <TouchableOpacity onPress={() => { Alert.alert('Compra Registrada') }} style={{
